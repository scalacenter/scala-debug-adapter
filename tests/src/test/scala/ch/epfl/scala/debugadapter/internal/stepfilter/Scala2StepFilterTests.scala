...
class Scala213StepFilterTests extends Scala2StepFilterTests(ScalaVersion.`2.13`)
class Scala212StepFilterTests extends Scala2StepFilterTests(ScalaVersion.`2.12`)

abstract class Scala2StepFilterTests(scalaVersion: ScalaVersion) extends FunSuite {
