...
lazy val javaDebug = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.easymock" % "easymock" % "5.6.0" % Test,
  ...
  .settings(
    ...
    crossScalaVersions ++= {
      SemVer(scalaVersion.value) match {
        ...
        // format: off
        case (2, 12, _) => Seq("2.12.21", "2.12.20", "2.12.19", "2.12.18", "2.12.17", "2.12.16", "2.12.15", "2.12.14", "2.12.13")
        case (2, 13, _) => Seq("2.13.18", "2.13.17", "2.13.16", "2.13.15", "2.13.14", "2.13.13", "2.13.12", "2.13.11", "2.13.10", "2.13.9", "2.13.8", "2.13.7", "2.13.6", "2.13.5", "2.13.4")
        case (3, 0, _) => Seq("3.0.2", "3.0.1", "3.0.0")
        case (3, 1 | 2 | 3, _) => Seq("3.3.8","3.3.7", "3.3.6", "3.3.5", "3.3.4", "3.3.3", "3.3.2", "3.3.1", "3.3.0", "3.2.2", "3.2.1", "3.2.0", "3.1.3", "3.1.2", "3.1.1", "3.1.0")
        case (3, _, _) => Seq("3.7.4", "3.7.3", "3.7.2", "3.7.1", "3.7.0", "3.6.4", "3.6.3", "3.6.2", "3.6.1", "3.5.2", "3.5.1", "3.5.0", "3.4.3", "3.4.2", "3.4.1", "3.4.0")
        case _ => Seq.empty
        // format: on
      }
    },
