...
abstract class MoreScala3EvaluationTests(scalaVersion: ScalaVersion) extends DebugTestSuite {

  override def tests: Tests = Tests {
    "evaluate shadowed variable" - {
      val source =
        """|package example
           |object Main {
    ...
    "brace-less syntax: public fields of objects" - {
      val source =
        """|package example
           |object A:
           |  val x1 = "x1"
    ...
    "brace-less syntax: private fields of class" - {
      val source =
        """|package example
           |class A:
           |  private val x1 = "x1"
    ...
    "brace-less syntax: public fields of outer class" - {
      val source =
        """|package example
           |class A:
           |  val x1 = "x1"
    ...
    "brace-less syntax: evaluate in package" - {
      val source =
        """package example:
          |  object Main:
          |    def main(args: Array[String]): Unit =
    ...
    "brace-less syntax: evaluate on method definition" - {
      val source =
        """|package example
           |class Foo:
    ...
    "brace-less syntax: private method call" - {
      val source =
        """|package example
           |class Foo:
           |  val foo = this
