...
object Dependencies {
  ...
  val scala34Plus = scalaEnvVersion.filter(isScala34).getOrElse("3.5.0-RC2")
  val asmVersion = "9.7"
  ...
  val sbtTestAgent = "org.scala-sbt" % "test-agent" % "1.10.1"
  val scalaMeta = ("org.scalameta" %% "parsers" % "4.9.7").cross(CrossVersion.for3Use2_13)
